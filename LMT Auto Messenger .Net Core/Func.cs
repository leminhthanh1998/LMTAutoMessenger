...
namespace LMT_Auto_Messenger_.Net_Core
{
    ...
    public class FacebookHttpRequest
    {
        ...
        public string SendMessage(AuthFaceBook client, string TextMessage, OptionMessage option)
        {
            if (client.IsLogin)
            {
                ...
                Stream newStream2 = getRequest.GetRequestStream(); //mở kết nối
                newStream2.Write(byteArray1, 0, byteArray1.Length); // gửi dữ liệu
                newStream2.Close();
    ...
    /// <summary>
    /// Nhap thong tin tin nhan va id nguoi nhan
    /// </summary>
